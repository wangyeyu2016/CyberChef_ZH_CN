...
class LS47Decrypt extends Operation {
    ...
    constructor() {
        ...
        this.module = "Crypto";
        this.description = "如Alan Kaminsky所述，这是对Elsiefour密码的略有改进。我们使用7x7个字符，而不是原始字符（几乎不拟合）6x6，以便能够加密一些结构化信息。我们还描述了一种简单的键性扩张算法，因为记住密码的记忆密码像Elsiefour Hold一样，相似的安全考虑。<br> LS47字母包括以下字符：<code> _abcdefghijklmnopqrstuvwxyz.0123456789， - +*/：？！然后在用于加密或解密的7x7网格中表示字母的排列。";
