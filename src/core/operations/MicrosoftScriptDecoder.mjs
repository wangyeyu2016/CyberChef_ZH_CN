...
class MicrosoftScriptDecoder extends Operation {
    ...
    constructor() {
        ...
        this.module = "Default";
        this.description = "解码已编码的Microsoft编码的脚本文件，这些文件已编码Microsoft的自定义编码。这些通常是vbs（Visual Basic脚本）文件，这些文件被编码和重命名为'.VBE'扩展名或JS（JScript）文件，并用'.jse'扩展名称命名为。<br> <br> <b>示例</b> <br> <br>编码：<br> <br> <code>＃@〜^rqaaaa ==  -  md〜sx |：/tp {〜j：+dybxl 〜@！f@*@！+@*@！解码：<br> <code> var my_msg =“ testing <1> <2> <3>！”";
