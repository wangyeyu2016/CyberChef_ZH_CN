...
class FromOctal extends Operation {
    ...
    constructor() {
        ...
        this.module = "Default";
        this.description = "将八分音字符串转换回其原始值。<br> <br> <br> e.g. <code> 316 223 316 265 316 271 271 316 254 40 317 203 316 277 317 317 205 </code>变成UTF-8编码字符串<code> γειάσου</code>";
