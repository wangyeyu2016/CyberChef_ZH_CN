...
class ToHex extends Operation {
    ...
    constructor() {
        ...
        this.name = "To Hex";
        this.module = "Default";
        this.description = "将输入字符串转换为由指定定界线分开的十六进制字节。<br> <br> <br>例如，UTF-8编码字符串<code>γει一切</code> </code>变为<code> CE 93 CE B5 CE B5 CE B9 CE AC 20 CF 83 CF 83 CF 83 CF 83 CE BF CF 85 0A </code>";
