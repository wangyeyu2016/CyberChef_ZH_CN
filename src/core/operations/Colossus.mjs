...
class Colossus extends Operation {
    ...
    constructor() {
        ...
        this.description = "Colossus是世界第一台电子计算机的名称。TENMOLOSSI是由Tommy Flowers设计的，并于1943年在Dollis Hill的邮局研究实验室建造。创建是为了加入希特勒和他的将军在前线之间的通信。<br> <br>要了解更多信息，虚拟巨像，在线，基于浏览器的巨像计算机的模拟，请访问<a href ='https：// virtualcolossus 。 gchq/cyberchef/wiki/colossus'target ='_ blank'>在这里</a>。";
