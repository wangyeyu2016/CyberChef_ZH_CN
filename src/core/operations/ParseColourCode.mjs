...
class ParseColourCode extends Operation {
    ...
    constructor() {
        ...
        this.module = "Default";
        this.description = "将标准格式的颜色代码转换为其他标准格式并显示颜色本身。<br> <br> <brang>示例输入</strong> <ul> <ul> <li> <li> <code>＃d9edf7 </code> </code> </code> </code> li> <li> <code> rgba（217,237,247,1）</code> </li> <li> <code> HSLA（200,65％，91％，1）</code> </code> </code> </li> <li > <code> cmyk（0.12，0.04，0.00，0.03）</code> </li> </ul>";
