...
class GenericCodeBeautify extends Operation {
    ...
    constructor() {
        ...
        this.module = "Code";
        this.description = "尝试打印漂亮的C风格语言，例如C，C ++，C＃，Java，PHP，Javascript等纯粹是为了使混淆或缩小的代码更易于阅读和理解。<br> <br> <br>无法正常工作的事物：<ul> <li>用于循环格式化</li> <li> do-do-while loop格式化< /li> <li>开关/案例凹痕</li> <li>某些位移动操作员</li> </ul>";
