...
class MultipleBombe extends Operation {
    ...
    constructor() {
        ...
        this.description = "炸弹机的仿真机器用于攻击Enigma。此版本进行多个Bombe运行以处理未知的转子配置。<br> <br> <br>您应该在单个Bombe操作上测试您的菜单，然后在此处运行。有关选择婴儿床的说明的操作。<br> <br>对谜，Typex和Bombe操作的更详细说明， - 和typex'>可以在此处找到</a>。";
